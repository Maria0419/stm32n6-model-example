...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "model_int8"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (16384)
...
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (16384)
